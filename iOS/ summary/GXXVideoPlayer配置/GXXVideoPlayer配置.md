...
![1.jpeg](/img/GXXVideoPlayer配置/1.jpeg)
...
<!--more-->
![2.jpeg](/img/GXXVideoPlayer配置/2.jpeg)


#### 在Other Linker Flags添加-ObjC,-lbz2,-liconv（注意大小写）

![3.jpeg](/img/GXXVideoPlayer配置/3.jpeg)

#### 在Preprocessor Marcos中，Debug添加：DEBUG=1,_LINUX,_IOS,SD_WEBP,Release添加：_IOS,_LINUX

![4.jpeg](/img/GXXVideoPlayer配置/4.jpeg)

![5.jpeg](/img/GXXVideoPlayer配置/5.jpeg)

![6.jpeg](/img/GXXVideoPlayer配置/6.jpeg)

#### 把项目中至少一个文件的.m后缀改成.mm支持c++.（例如修改AppDelegate.m为AppDelegate.mm）

![7.jpeg](/img/GXXVideoPlayer配置/7.jpeg)
